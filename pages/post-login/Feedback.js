  ...
  return (
    <View style={{ flex: 1, backgroundColor:'#0F172B' }}>
        <View style={{ padding:20, display:'flex', justifyContent:'space-between', flexDirection: 'row', backgroundColor:'#1D283A' }}>
            ...
            <FastImage source={crossIcon} style={{ width: scale(15), height: scale(15), marginTop:moderateVerticalScale(6) }} />
            </TouchableOpacity>
        </View>
        ...
        <View style={style.profileList}>
            <View style={{ display:'flex', width:'100%',marginTop:moderateVerticalScale(100), padding:moderateVerticalScale(11) }}>
                <FastImage source={feedback} style={{ width: scale(100), height: scale(100), marginTop:moderateVerticalScale(6), alignSelf:'center' }} />
                <Text style={{color:'#FFFF', textAlign:'center', width:'100%', fontWeight:'600', fontSize:20, marginTop:moderateVerticalScale(15)}}>Feedback Shared</Text>
                <Text style={{color:'#FFFF', textAlign:'center', width:'100%', fontWeight:'400', fontSize:13, paddingTop:moderateVerticalScale(15), marginLeft:moderateVerticalScale(10)}}>Thankyou for helping us improve</Text>
